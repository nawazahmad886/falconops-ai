...
# MONGO_URL / DB_NAME / REDIS_URL are overridden by docker-compose.yml's
# 'environment:' block to point at the sidecar containers — no need to set
# them here for the Docker route.
